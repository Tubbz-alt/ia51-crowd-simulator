...
public interface Time extends Comparable<Time> {
   ...
   */
  @DefaultValueSource
  public abstract double getCurrentTime(@DefaultValue("framework.time.Time#GETCURRENTTIME_0") final TimeUnit unit);
  ...
  @SyntheticMember
  @SarlSourceCode("null")
  public final static TimeUnit $DEFAULT_VALUE$GETCURRENTTIME_0 = null;
   ...
   */
  @DefaultValueSource
  public abstract double getLastStepDuration(@DefaultValue("framework.time.Time#GETLASTSTEPDURATION_0") final TimeUnit unit);
  ...
  @SyntheticMember
  @SarlSourceCode("null")
  public final static TimeUnit $DEFAULT_VALUE$GETLASTSTEPDURATION_0 = null;
   ...
   */
  public abstract double perSecond(final double amountPerSecond);
  ...
  @SyntheticMember
  public default double getCurrentTime() {
  ...
  @DefaultValueUse("java.util.concurrent.TimeUnit")
  @SyntheticMember
  public default double getLastStepDuration() {
